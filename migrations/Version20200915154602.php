 ...
 */
final class Version20200915154602 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE progress (id INT AUTO_INCREMENT NOT NULL, question_id INT NOT NULL, result_id INT DEFAULT NULL, is_right TINYINT(1) NOT NULL, INDEX UNIQ_2201F2461E27F6BF (question_id), INDEX IDX_2201F2467A7B643 (result_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE progress ADD CONSTRAINT FK_2201F2461E27F6BF FOREIGN KEY (question_id) REFERENCES question (id)');
        $this->addSql('ALTER TABLE progress ADD CONSTRAINT FK_2201F2467A7B643 FOREIGN KEY (result_id) REFERENCES result (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE progress DROP FOREIGN KEY FK_2201F2461E27F6BF');
        ...
        $this->addSql('ALTER TABLE progress DROP FOREIGN KEY FK_2201F2467A7B643');
